...
def open_edit(root, search, gjenstand_data=None):
    ...
    OptionMenu(identifikasjon_group, kategori, *choices).grid(row=r,column=1)
    ...
    #Produsent
    r+=1
    Label(proveniens_group,text="Materiale:",width=25).grid(row=r,column=0,sticky=W)
    ...
    #Fysiske Giver/Siste eier
    r+=1
    Label(proveniens_group,text="Giver/Siste eier:",width=25).grid(row=r,column=0,sticky=W)
