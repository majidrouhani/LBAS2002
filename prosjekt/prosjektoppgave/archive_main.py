from tkinter import *
import prosjekt.prosjektoppgave.archive_edit as archive_edit
import prosjekt.prosjektoppgave.archive_db as archive_db
import prosjekt.prosjektoppgave.archive_statistics as archive_statistics
...
Beskrivesle:
Dette er forslag til en minimumsløsning for prosjektet i fag LBAS2002 Informatikk (2018 HØST).
...
def edit_gjenstand(event):
    """
    Når bruker dobbel-klikker på en gjenstand i listen (søke-resultatet), sendes første kolonnen (regnr) i litsen som
    parameter til funksjonen archive_edit.open_edit
    Denne funksjonen slår opp i databasen og henter all data relatert til denne gjenstaden.
    """
